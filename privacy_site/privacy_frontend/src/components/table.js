          ...
          <tbody>
            {this.state.appList.map((item) => (
              <tr key={item.id}>
                ...
                <td>{item.app_name}</td>
                <td>{this.privacyTypeMethod(item.privacy_type)}</td>
                <td>{this.purposeMethod(item.purpose)}</td>
                <td>{this.dataCategoryMethod(item.data_category)}</td>
                <td>{this.dataTypeMethod(item.data_type)}</td>
